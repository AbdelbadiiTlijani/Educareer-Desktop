...
public class ChatBoxController {
    ...
    public void connectSocket() {
        try {
            ...
            e.printStackTrace();
            showMessage("Error: Impossible de se connecter au serveur.", false);
        }
    }
    ...
    public void listenForMessages() {
        new Thread(() -> {
            ...
            try {
                ...
                e.printStackTrace();
                showMessage("Error: Impossible d'envoyer.", false);
            }
        }).start();
    }
    ...
    public void handleSearchRecipient() {
        ...
        if (user != null) {
            ...
            showMessage("Recepteur trouvé: " + user.getNom() + " " + user.getPrenom(), false);
            showMessage("---------------------------------------------------", false);
            loadMessages();

        } else {
            showMessage("Recepteur non trouvé.", false);
        }
    }
    ...
    public void handleSendMessage() {
        if (recipientId == -1) {
            showMessage("Précisez le recepteur svp.", false);
            return;
        }
        ...
        if (writer == null) {
            showMessage("Error: Pas connecté au serveur.", false);
            return;
        }
        ...
        try {
            ...
            titleField.clear();
            messageField.clear();
            showMessage("Message envoyé :)!", true);
    ...
    private void loadMessages() {
        ...
        sm.markMessagesAsRead(recipientId, senderId);
    }
